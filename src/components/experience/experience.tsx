...
export default function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      ...
      type: 'Contract',
      description:
        'Architected and implemented scalable backend systems, focusing on APIs, databases, and real time infrastructure. Worked closely with cross functional teams to ensure reliability, security, and performance of mission critical applications.',
      achievements: [
        'Designed and deployed microservices architecture serving 1M+ monthly users',
        'Built a real time chat and notification system handling 10,000+ daily active users',
        'Optimized database queries and indexing, reducing response times by 40%',
        'Implemented CI/CD pipelines, cutting deployment time by 60%',
        'Introduced monitoring and logging systems (ELK stack), improving issue detection',
      ],
      technologies: [
        'Node.js',
        'NestJS',
    ...
    },
    {
      ...
      achievements: [
        'Developed mobile applications (MVP) for 8 different startup',
    ...
    },
    {
      ...
      company: 'Ufusion International',
      location: 'Gilgit, Pakistan',
      period: '2017 - 2019',
      type: 'Internship',
      description:
        'Began my professional career by building responsive websites for small and mid sized businesses. Gained hands on experience with frontend and backend development while learning industry best practices and collaborating in a team environment.',
      achievements: [
        'Delivered 25+ responsive business websites using HTML, CSS, and JavaScript',
        'Assisted in developing dynamic features with PHP and MySQL',
        'Collaborated with senior developers on e-commerce and CMS projects',
        'Ensured cross-browser compatibility and mobile responsiveness for all projects',
        'Provided ongoing maintenance and bug fixes to ensure 99.9% uptime',
      ],
      technologies: [
        'HTML5',
        'CSS3',
  ...
  const education = [
    {
      ...
      period: '2015 - 2019',
      description:
        'Graduated with honors, focusing on software engineering and web development. Completed several projects including a capstone project on blockchain application.',
      achievements: [
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            expertise in creating extraordinary products
          </p>
        </motion.div>
